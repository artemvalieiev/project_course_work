...
from ..predictor import CTWinAfterPlantPredictor


class CTWinAfterPlant(tornado.web.RequestHandler):
    def initialize(self, predictor: CTWinAfterPlantPredictor, version: int) -> None:
